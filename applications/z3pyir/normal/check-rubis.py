...
class Op_StoreBid_doPost_74():
    ...
    def cond1(self, state, argv):
        ...
        bid = argv['StoreBid_doPost_74']['bid']
        itemId = argv['StoreBid_doPost_74']['itemId']
        return And((Not(qty > maxQty)),(Not(bid < minBid)),(Not(maxBid < minBid)),(Not(maxBid < bid)),((state['TABLE_items'].notNil({'id' : itemId}) == True)),((bid > state['TABLE_items'].get({'id' : itemId}, 'max_bid'))))
