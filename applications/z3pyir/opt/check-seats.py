...
CUSTOMER.addAttr('__TS', Table.Type.INT)
...
class Op_UpdateCustomer_run_53():
    ...
    def csop0(self, state, argv):
        c_id = argv['UpdateCustomer_run_53']['c_id']
        __ts = argv['UpdateCustomer_run_53']['__ts']
        return And(state['TABLE_CUSTOMER'].get({'C_ID' : c_id}, '__TS') < __ts)
    ...
    def sop0(self, state, argv):
        ...
        C_IATTR00 = attr0
        C_IATTR01 = attr1
        state['TABLE_CUSTOMER'].update({'C_ID' : c_id}, {'C_IATTR00' : C_IATTR00,'C_IATTR01' : C_IATTR01,'__TS' : __ts})
        return state
...
class Op_NewReservation_run_116():
    ...
    def sop0(self, state, argv):
        ...
        R_IATTR07 = attrs7
        R_IATTR08 = attrs8
        state['TABLE_RESERVATION'].add({'R_ID' : r_id,'R_C_ID' : c_id,'R_F_ID' : f_id,'R_SEAT' : seatnum}, {'R_PRICE' : R_PRICE,'R_IATTR00' : R_IATTR00,'R_IATTR01' : R_IATTR01,'R_IATTR02' : R_IATTR02,'R_IATTR03' : R_IATTR03,'R_IATTR04' : R_IATTR04,'R_IATTR05' : R_IATTR05,'R_IATTR06' : R_IATTR06,'R_IATTR07' : R_IATTR07,'R_IATTR08' : R_IATTR08})
        f_id = argv['NewReservation_run_116']['f_id']
        c_id = argv['NewReservation_run_116']['c_id']
...
class Op_DeleteReservation_run_59():
    ...
    def csop0(self, state, argv):
        c_id = argv['DeleteReservation_run_59']['c_id']
        __ts = argv['DeleteReservation_run_59']['__ts']
        return And(state['TABLE_CUSTOMER'].get({'C_ID' : c_id}, '__TS') < __ts)
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_CUSTOMER'].update({'C_ID' : c_id}, {'C_BALANCE' : C_BALANCE,'C_IATTR00' : C_IATTR00,'C_IATTR10' : C_IATTR10,'C_IATTR11' : C_IATTR11,'__TS' : __ts})
        return state
