...
BloodGroupingRh.addAttr('__ts', Table.Type.INT)
...
LipidTest.addAttr('__ts', Table.Type.INT)
...
LiverFunctionTest.addAttr('__ts', Table.Type.INT)
...
RenalFunctionTest.addAttr('__ts', Table.Type.INT)
...
SeriumCreatinePhosphokinase.addAttr('__ts', Table.Type.INT)
...
SeriumCreatinePhosphokinaseTotal.addAttr('__ts', Table.Type.INT)
...
UrineFullReport.addAttr('__ts', Table.Type.INT)
...
appointment.addAttr('__ts', Table.Type.INT)
...
bill.addAttr('__ts', Table.Type.INT)
...
completeBloodCount.addAttr('__ts', Table.Type.INT)
...
diagnose_history.addAttr('__ts', Table.Type.INT)
...
doctor.addAttr('__ts', Table.Type.INT)
...
doctor_availability.addAttr('__ts', Table.Type.INT)
...
drug.addAttr('__ts', Table.Type.INT)
...
drug_brand_names.addAttr('__ts', Table.Type.INT)
...
lab_appointment.addAttr('__ts', Table.Type.INT)
...
lab_appointment_timetable.addAttr('__ts', Table.Type.INT)
...
lab_assistant.addAttr('__ts', Table.Type.INT)
...
lab_test.addAttr('__ts', Table.Type.INT)
...
medical_history.addAttr('__ts', Table.Type.INT)
...
patient.addAttr('__ts', Table.Type.INT)
...
patient_message_receive.addAttr('__ts', Table.Type.INT)
...
patient_message_send.addAttr('__ts', Table.Type.INT)
...
patient_useraccount.addAttr('__ts', Table.Type.INT)
...
person.addAttr('__ts', Table.Type.INT)
...
pharmacist.addAttr('__ts', Table.Type.INT)
...
pharmacy_history.addAttr('__ts', Table.Type.INT)
...
pharmacy_stock.addAttr('__ts', Table.Type.INT)
...
prescription.addAttr('__ts', Table.Type.INT)
...
refund.addAttr('__ts', Table.Type.INT)
...
signup.addAttr('__ts', Table.Type.INT)
signup.setPKey('id')
signup.build()
...
suppliers.addAttr('__ts', Table.Type.INT)
...
sys_user.addAttr('__ts', Table.Type.INT)
...
tempappointment.addAttr('__ts', Table.Type.INT)
...
tmp_bill.addAttr('__ts', Table.Type.INT)
...
user_message.addAttr('__ts', Table.Type.INT)
...
website_messages.addAttr('__ts', Table.Type.INT)
...
def GenArgv():
    ...
    builder.AddArgv('__ts', ArgvBuilder.Type.INT)
...
class Op_Doctor_doctorTimeTableAddSlot_run_8412():
    def __init__(self):
        ...
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Doctor_doctorTimeTableAddSlot_run_8412', 'newTimeSlotId'), AxiomUniqueArguments('Op_Doctor_doctorTimeTableAddSlot_run_8412', ['slmcReg', 'timeSlot', 'day']))

    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_doctorTimeTableAddSlot_run_8412']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_doctorTimeTableAddSlot_run_8412']['now']
        __ts = argv['Op_Doctor_doctorTimeTableAddSlot_run_8412']['__ts']
        newTimeSlotId = argv['Op_Doctor_doctorTimeTableAddSlot_run_8412']['newTimeSlotId']
        slmcReg = argv['Op_Doctor_doctorTimeTableAddSlot_run_8412']['slmcReg']
        day = argv['Op_Doctor_doctorTimeTableAddSlot_run_8412']['day']
        ...
        doctor_availability__ts = state['TABLE_doctor_availability'].get({'time_slot_id': doctor_availability_time_slot_id}, '__ts')
        return And((doctor_availability__ts < now))
...
class Op_Pharmacist_addNewDrug2_run_8413():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Pharmacist_addNewDrug2_run_8413', 'newDrugId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_addNewDrug2_run_8413']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_addNewDrug2_run_8413']['now']
        __ts = argv['Op_Pharmacist_addNewDrug2_run_8413']['__ts']
        newDrugId = argv['Op_Pharmacist_addNewDrug2_run_8413']['newDrugId']
        drugName = argv['Op_Pharmacist_addNewDrug2_run_8413']['drugName']
        ...
        drug__ts = state['TABLE_drug'].get({'drug_id': drug_drug_id}, '__ts')
        return And((drug__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        drug_drug_name = argv['Op_Pharmacist_addNewDrug2_run_8413']['drugName']
        drug_dangerous_drug = 0
        state['TABLE_drug'].add({'drug_id': drug_drug_id}, {'drug_name': drug_drug_name,'dangerous_drug': drug_dangerous_drug, '__ts': now})
        return state
...
class Op_Cashier_bill_run_8414():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Cashier_bill_run_8414', 'newBillId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Cashier_bill_run_8414']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Cashier_bill_run_8414']['now']
        __ts = argv['Op_Cashier_bill_run_8414']['__ts']
        newBillId = argv['Op_Cashier_bill_run_8414']['newBillId']
        date = argv['Op_Cashier_bill_run_8414']['date']
        doctorFee = argv['Op_Cashier_bill_run_8414']['doctorFee']
        ...
        bill__ts = state['TABLE_bill'].get({'bill_id': bill_bill_id}, '__ts')
        return And((bill__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        bill_patient_id = argv['Op_Cashier_bill_run_8414']['patientId']
        bill_refund = argv['Op_Cashier_bill_run_8414']['refund']
        state['TABLE_bill'].add({'bill_id': bill_bill_id}, {'bill_date': bill_bill_date,'doctor_fee': bill_doctor_fee,'hospital_fee': bill_hospital_fee,'pharmacy_fee': bill_pharmacy_fee,'laboratory_fee': bill_laboratory_fee,'appointment_fee': bill_appointment_fee,'vat': bill_vat,'discount': bill_discount,'total': bill_total,'payment_method': bill_payment_method,'consultant_id': bill_consultant_id,'patient_id': bill_patient_id,'refund': bill_refund, '__ts': now})
        return state
...
class Op_Pharmacist_updateStock_run_8415():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Pharmacist_updateStock_run_8415', 'newStockId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_updateStock_run_8415']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_updateStock_run_8415']['now']
        __ts = argv['Op_Pharmacist_updateStock_run_8415']['__ts']
        newStockId = argv['Op_Pharmacist_updateStock_run_8415']['newStockId']
        drugId = argv['Op_Pharmacist_updateStock_run_8415']['drugId']
        brandId = argv['Op_Pharmacist_updateStock_run_8415']['brandId']
        ...
        pharmacy_stock__ts = state['TABLE_pharmacy_stock'].get({'stock_id': pharmacy_stock_stock_id}, '__ts')
        return And((pharmacy_stock__ts < now))
...
class Op_Pharmacist_reduceStock_run_8416():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_reduceStock_run_8416']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_reduceStock_run_8416']['now']
        __ts = argv['Op_Pharmacist_reduceStock_run_8416']['__ts']
        id = argv['Op_Pharmacist_reduceStock_run_8416']['id']
        pharmacy_stock_stock_id = argv['Op_Pharmacist_reduceStock_run_8416']['pharmacy_stock_stock_id']
        pharmacy_stock__ts = state['TABLE_pharmacy_stock'].get({'stock_id': argv['Op_Pharmacist_reduceStock_run_8416']['id']}, '__ts')
        return And((pharmacy_stock__ts < now))
...
class Op_LabAssistant_updateLabAssistantInfo_run_8417():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['now']
        __ts = argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['__ts']
        id = argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['id']
        lab_assistant_lab_assistant_id = argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['lab_assistant_lab_assistant_id']
        lab_assistant__ts = state['TABLE_lab_assistant'].get({'lab_assistant_id': argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['id']}, '__ts')
        return And((lab_assistant__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_lab_assistant'].update({'lab_assistant_id': argv['Op_LabAssistant_updateLabAssistantInfo_run_8417']['id']}, {'lab_assistant_id': lab_assistant_lab_assistant_id, 'user_id': lab_assistant_user_id, 'education': lab_assistant_education, 'training': lab_assistant_training, 'experience': lab_assistant_experience, 'achievements': lab_assistant_achievements, '__ts': now})
        return state
...
class Op_Receptionist_updateAccountInfo_run_8418():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_updateAccountInfo_run_8418']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Receptionist_updateAccountInfo_run_8418']['now']
        __ts = argv['Op_Receptionist_updateAccountInfo_run_8418']['__ts']
        id = argv['Op_Receptionist_updateAccountInfo_run_8418']['id']
        doctor_user_id = argv['Op_Receptionist_updateAccountInfo_run_8418']['doctor_user_id']
        sys_user_user_id = argv['Op_Receptionist_updateAccountInfo_run_8418']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_Receptionist_updateAccountInfo_run_8418']['id']}, 'user_id')}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_sys_user'].update({'user_id': state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_Receptionist_updateAccountInfo_run_8418']['id']}, 'user_id')}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_Doctor_diagnose_run_8419():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Doctor_diagnose_run_8419', 'newHistoryId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_diagnose_run_8419']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_diagnose_run_8419']['now']
        __ts = argv['Op_Doctor_diagnose_run_8419']['__ts']
        newHistoryId = argv['Op_Doctor_diagnose_run_8419']['newHistoryId']
        patientId = argv['Op_Doctor_diagnose_run_8419']['patientId']
        doctorId = argv['Op_Doctor_diagnose_run_8419']['doctorId']
        ...
        medical_history__ts = state['TABLE_medical_history'].get({'history_id': medical_history_history_id}, '__ts')
        return And((medical_history__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        medical_history_date = 1451606400
        medical_history_history = StringVal('Took medicine for dengue fever')
        state['TABLE_medical_history'].add({'history_id': medical_history_history_id}, {'patient_id': medical_history_patient_id,'doctor_id': medical_history_doctor_id,'date': medical_history_date,'history': medical_history_history, '__ts': now})
        return state
...
class Op_Pharmacist_updateAccountInfo_run_8420():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_updateAccountInfo_run_8420']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_updateAccountInfo_run_8420']['now']
        __ts = argv['Op_Pharmacist_updateAccountInfo_run_8420']['__ts']
        pharmacistId = argv['Op_Pharmacist_updateAccountInfo_run_8420']['pharmacistId']
        pharmacist_user_id = argv['Op_Pharmacist_updateAccountInfo_run_8420']['pharmacist_user_id']
        sys_user_user_id = argv['Op_Pharmacist_updateAccountInfo_run_8420']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': state['TABLE_pharmacist'].get({'pharmacist_id': argv['Op_Pharmacist_updateAccountInfo_run_8420']['pharmacistId']}, 'user_id')}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_sys_user'].update({'user_id': state['TABLE_pharmacist'].get({'pharmacist_id': argv['Op_Pharmacist_updateAccountInfo_run_8420']['pharmacistId']}, 'user_id')}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_LabAssistant_UrineFullReport_run_8421():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_UrineFullReport_run_8421', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_UrineFullReport_run_8421']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        UrineFullReport__ts = state['TABLE_UrineFullReport'].get({'tst_ur_id': UrineFullReport_tst_ur_id}, '__ts')
        return And((UrineFullReport__ts < now))
...
class Op_Receptionist_cancelAppointment_run_8422():
    def __init__(self):
        ...
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Receptionist_cancelAppointment_run_8422', 'newRefundId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_cancelAppointment_run_8422']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        appointmentId = argv['Op_Receptionist_cancelAppointment_run_8422']['appointmentId']
        appointment_appointment_id = argv['Op_Receptionist_cancelAppointment_run_8422']['appointment_appointment_id']
        appointment__ts = state['TABLE_appointment'].get({'appointment_id': argv['Op_Receptionist_cancelAppointment_run_8422']['appointmentId']}, '__ts')
        return And((appointment__ts < now))
    ...
    def csop1(self, state, argv):
        ...
        refund__ts = state['TABLE_refund'].get({'refund_id': refund_refund_id}, '__ts')
        return And((appointment__ts < now), (refund__ts < now))
    ...
    def sop1(self, state, argv):
        ...
        refund_amount = state['TABLE_bill'].get({'bill_id': state['TABLE_appointment'].get({'appointment_id': argv['Op_Receptionist_cancelAppointment_run_8422']['appointmentId']}, 'bill_id')}, 'total')
        refund_date = argv['Op_Receptionist_cancelAppointment_run_8422']['now']
        state['TABLE_refund'].add({'refund_id': refund_refund_id}, {'bill_id': refund_bill_id,'payment_type': refund_payment_type,'reason': refund_reason,'amount': refund_amount,'date': refund_date, '__ts': now})
        return state
    ...
    def csop2(self, state, argv):
        ...
        refund_date = argv['Op_Receptionist_cancelAppointment_run_8422']['now']
        refund__ts = state['TABLE_refund'].get({'refund_id': refund_refund_id}, '__ts')
        bill__ts = state['TABLE_bill'].get({'bill_id': state['TABLE_appointment'].get({'appointment_id': argv['Op_Receptionist_cancelAppointment_run_8422']['appointmentId']}, 'bill_id')}, '__ts')
        return And((appointment__ts < now), (refund__ts < now), (bill__ts < now))
    ...
    def sop2(self, state, argv):
        ...
        bill_refund = 1
        state['TABLE_bill'].update({'bill_id': state['TABLE_appointment'].get({'appointment_id': argv['Op_Receptionist_cancelAppointment_run_8422']['appointmentId']}, 'bill_id')}, {'bill_id': bill_bill_id, 'bill_date': bill_bill_date, 'doctor_fee': bill_doctor_fee, 'hospital_fee': bill_hospital_fee, 'pharmacy_fee': bill_pharmacy_fee, 'laboratory_fee': bill_laboratory_fee, 'appointment_fee': bill_appointment_fee, 'vat': bill_vat, 'discount': bill_discount, 'total': bill_total, 'payment_method': bill_payment_method, 'consultant_id': bill_consultant_id, 'patient_id': bill_patient_id, 'refund': bill_refund, '__ts': now})
        return state
...
class Op_Cashier_makeRefund_run_8423():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Cashier_makeRefund_run_8423']['__ts']
        id = argv['Op_Cashier_makeRefund_run_8423']['id']
        return True

    def csop0(self, state, argv):
        now = argv['Op_Cashier_makeRefund_run_8423']['now']
        __ts = argv['Op_Cashier_makeRefund_run_8423']['__ts']
        id = argv['Op_Cashier_makeRefund_run_8423']['id']
        return And()
...
class Op_Cashier_refund_run_8424():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Cashier_refund_run_8424', 'newRefundId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Cashier_refund_run_8424']['__ts']
...
class Op_Doctor_allergies_run_8425():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_allergies_run_8425']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_allergies_run_8425']['now']
        __ts = argv['Op_Doctor_allergies_run_8425']['__ts']
        patientId = argv['Op_Doctor_allergies_run_8425']['patientId']
        patient_drug_allergies_and_reactions = argv['Op_Doctor_allergies_run_8425']['patient_drug_allergies_and_reactions']
        allergies = argv['Op_Doctor_allergies_run_8425']['allergies']
        patient_patient_id = argv['Op_Doctor_allergies_run_8425']['patient_patient_id']
        patient__ts = state['TABLE_patient'].get({'patient_id': argv['Op_Doctor_allergies_run_8425']['patientId']}, '__ts')
        return And((patient__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_patient'].update({'patient_id': argv['Op_Doctor_allergies_run_8425']['patientId']}, {'patient_id': patient_patient_id, 'person_id': patient_person_id, 'drug_allergies_and_reactions': patient_drug_allergies_and_reactions, '__ts': now})
        return state
...
class Op_Admin_createNewUser_run_8426():
    def __init__(self):
        ...
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Admin_createNewUser_run_8426', 'newPersonId'), AxiomUniqueArgument('Op_Admin_createNewUser_run_8426', 'newUserId'), AxiomUniqueArgument('Op_Admin_createNewUser_run_8426', 'newLabAssistantId'), AxiomUniqueArgument('Op_Admin_createNewUser_run_8426', 'newPharmacistId'), AxiomUniqueArgument('Op_Admin_createNewUser_run_8426', 'newSlmcReg'))

    def cond0(self, state, argv):
        __ts = argv['Op_Admin_createNewUser_run_8426']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Admin_createNewUser_run_8426']['now']
        __ts = argv['Op_Admin_createNewUser_run_8426']['__ts']
        newPersonId = argv['Op_Admin_createNewUser_run_8426']['newPersonId']
        firstName = argv['Op_Admin_createNewUser_run_8426']['firstName']
        lastName = argv['Op_Admin_createNewUser_run_8426']['lastName']
        ...
        person__ts = state['TABLE_person'].get({'person_id': person_person_id}, '__ts')
        return And((person__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        person_nic = argv['Op_Admin_createNewUser_run_8426']['nic']
        person_mobile = argv['Op_Admin_createNewUser_run_8426']['mobile']
        state['TABLE_person'].add({'person_id': person_person_id}, {'first_name': person_first_name,'last_name': person_last_name,'nic': person_nic,'mobile': person_mobile, '__ts': now})
        return state
    ...
    def csop3(self, state, argv):
        ...
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': sys_user_user_id}, '__ts')
        return And((person__ts < now), (sys_user__ts < now))
    ...
    def sop3(self, state, argv):
        ...
        sys_user_user_type = argv['Op_Admin_createNewUser_run_8426']['userType']
        sys_user_password = StringVal('1234')
        state['TABLE_sys_user'].add({'user_id': sys_user_user_id}, {'person_id': sys_user_person_id,'user_name': sys_user_user_name,'user_type': sys_user_user_type,'password': sys_user_password, '__ts': now})
        return state
    ...
    def csop6(self, state, argv):
        ...
        lab_assistant__ts = state['TABLE_lab_assistant'].get({'lab_assistant_id': lab_assistant_lab_assistant_id}, '__ts')
        return And((person__ts < now), (sys_user__ts < now), (lab_assistant__ts < now))
    ...
    def sop6(self, state, argv):
        ...
        lab_assistant_lab_assistant_id = argv['Op_Admin_createNewUser_run_8426']['newLabAssistantId']
        lab_assistant_user_id = argv['Op_Admin_createNewUser_run_8426']['newUserId']
        state['TABLE_lab_assistant'].add({'lab_assistant_id': lab_assistant_lab_assistant_id}, {'user_id': lab_assistant_user_id, '__ts': now})
        return state
    ...
    def csop7(self, state, argv):
        ...
        pharmacist__ts = state['TABLE_pharmacist'].get({'pharmacist_id': pharmacist_pharmacist_id}, '__ts')
        return And((person__ts < now), (sys_user__ts < now), (pharmacist__ts < now))
    ...
    def sop7(self, state, argv):
        ...
        pharmacist_pharmacist_id = argv['Op_Admin_createNewUser_run_8426']['newPharmacistId']
        pharmacist_user_id = argv['Op_Admin_createNewUser_run_8426']['newUserId']
        state['TABLE_pharmacist'].add({'pharmacist_id': pharmacist_pharmacist_id}, {'user_id': pharmacist_user_id, '__ts': now})
        return state
    ...
    def csop8(self, state, argv):
        ...
        doctor__ts = state['TABLE_doctor'].get({'slmc_reg_no': doctor_slmc_reg_no}, '__ts')
        return And((person__ts < now), (sys_user__ts < now), (doctor__ts < now))
    ...
    def sop8(self, state, argv):
        ...
        sys_user_user_type = argv['Op_Admin_createNewUser_run_8426']['userType']
        sys_user_password = StringVal('1234')
        state['TABLE_sys_user'].add({'user_id': sys_user_user_id}, {'person_id': sys_user_person_id,'user_name': sys_user_user_name,'user_type': sys_user_user_type,'password': sys_user_password,'suspend':0, '__ts': now})
        doctor_slmc_reg_no = argv['Op_Admin_createNewUser_run_8426']['newSlmcReg']
        doctor_user_id = argv['Op_Admin_createNewUser_run_8426']['newUserId']
        state['TABLE_doctor'].add({'slmc_reg_no': doctor_slmc_reg_no}, {'user_id': doctor_user_id, '__ts': now})
        return state
...
class Op_Pharmacist_bill_run_8427():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_bill_run_8427']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_bill_run_8427']['now']
        __ts = argv['Op_Pharmacist_bill_run_8427']['__ts']
        id = argv['Op_Pharmacist_bill_run_8427']['id']
        tmp_bill_tmp_bill_id = argv['Op_Pharmacist_bill_run_8427']['tmp_bill_tmp_bill_id']
        tmp_bill__ts = state['TABLE_tmp_bill'].get({'tmp_bill_id': state['TABLE_tmp_bill'].get({'patient_id': argv['Op_Pharmacist_bill_run_8427']['id']}, 'tmp_bill_id')}, '__ts')
        return And((tmp_bill__ts < now))
...
class Op_Receptionist_updatePatientInfo_run_8428():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_updatePatientInfo_run_8428']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Receptionist_updatePatientInfo_run_8428']['now']
        __ts = argv['Op_Receptionist_updatePatientInfo_run_8428']['__ts']
        patientId = argv['Op_Receptionist_updatePatientInfo_run_8428']['patientId']
        info = argv['Op_Receptionist_updatePatientInfo_run_8428']['info']
        patient_patient_id = argv['Op_Receptionist_updatePatientInfo_run_8428']['patient_patient_id']
        patient__ts = state['TABLE_patient'].get({'patient_id': argv['Op_Receptionist_updatePatientInfo_run_8428']['patientId']}, '__ts')
        return And((patient__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_patient'].update({'patient_id': argv['Op_Receptionist_updatePatientInfo_run_8428']['patientId']}, {'patient_id': patient_patient_id, 'person_id': patient_person_id, 'drug_allergies_and_reactions': patient_drug_allergies_and_reactions, '__ts': now})
        return state
...
class Op_Doctor_updateDoctorInfo_run_8429():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_updateDoctorInfo_run_8429']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_updateDoctorInfo_run_8429']['now']
        __ts = argv['Op_Doctor_updateDoctorInfo_run_8429']['__ts']
        id = argv['Op_Doctor_updateDoctorInfo_run_8429']['id']
        doctor_slmc_reg_no = argv['Op_Doctor_updateDoctorInfo_run_8429']['doctor_slmc_reg_no']
        doctor__ts = state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_Doctor_updateDoctorInfo_run_8429']['id']}, '__ts')
        return And((doctor__ts < now))
...
class Op_Receptionist_updateProfileInfo_run_8430():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_updateProfileInfo_run_8430']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Receptionist_updateProfileInfo_run_8430']['now']
        __ts = argv['Op_Receptionist_updateProfileInfo_run_8430']['__ts']
        userId = argv['Op_Receptionist_updateProfileInfo_run_8430']['userId']
        address = argv['Op_Receptionist_updateProfileInfo_run_8430']['address']
        sys_user_person_id = argv['Op_Receptionist_updateProfileInfo_run_8430']['sys_user_person_id']
        person_person_id = argv['Op_Receptionist_updateProfileInfo_run_8430']['person_person_id']
        person__ts = state['TABLE_person'].get({'person_id': state['TABLE_sys_user'].get({'user_id': argv['Op_Receptionist_updateProfileInfo_run_8430']['userId']}, 'person_id')}, '__ts')
        return And((person__ts < now))
...
class Op_LabAssistant_SeriumCreatinePhosphokinaseTotal_run_8431():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_SeriumCreatinePhosphokinaseTotal_run_8431', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_SeriumCreatinePhosphokinaseTotal_run_8431']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        SeriumCreatinePhosphokinaseTotal__ts = state['TABLE_SeriumCreatinePhosphokinaseTotal'].get({'tst_SCPT_id': SeriumCreatinePhosphokinaseTotal_tst_SCPT_id}, '__ts')
        return And((SeriumCreatinePhosphokinaseTotal__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        SeriumCreatinePhosphokinaseTotal_cpkTotal = argv['Op_LabAssistant_SeriumCreatinePhosphokinaseTotal_run_8431']['cpkTotal']
        SeriumCreatinePhosphokinaseTotal_date = argv['Op_LabAssistant_SeriumCreatinePhosphokinaseTotal_run_8431']['now']
        state['TABLE_SeriumCreatinePhosphokinaseTotal'].add({'tst_SCPT_id': SeriumCreatinePhosphokinaseTotal_tst_SCPT_id}, {'appointment_id': SeriumCreatinePhosphokinaseTotal_appointment_id,'cpkTotal': SeriumCreatinePhosphokinaseTotal_cpkTotal,'date': SeriumCreatinePhosphokinaseTotal_date, '__ts': now})
        return state
...
class Op_Cashier_updateAccountInfo_run_8432():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Cashier_updateAccountInfo_run_8432']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Cashier_updateAccountInfo_run_8432']['now']
        __ts = argv['Op_Cashier_updateAccountInfo_run_8432']['__ts']
        id = argv['Op_Cashier_updateAccountInfo_run_8432']['id']
        sys_user_user_id = argv['Op_Cashier_updateAccountInfo_run_8432']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': argv['Op_Cashier_updateAccountInfo_run_8432']['id']}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_sys_user'].update({'user_id': argv['Op_Cashier_updateAccountInfo_run_8432']['id']}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_Admin_suspendUser_run_8433():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Admin_suspendUser_run_8433']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Admin_suspendUser_run_8433']['now']
        __ts = argv['Op_Admin_suspendUser_run_8433']['__ts']
        id = argv['Op_Admin_suspendUser_run_8433']['id']
        sys_user_user_id = argv['Op_Admin_suspendUser_run_8433']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': argv['Op_Admin_suspendUser_run_8433']['id']}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        sys_user_suspend = 1
        state['TABLE_sys_user'].update({'user_id': argv['Op_Admin_suspendUser_run_8433']['id']}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_Doctor_updateProfileInfo_run_8434():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_updateProfileInfo_run_8434']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_updateProfileInfo_run_8434']['now']
        __ts = argv['Op_Doctor_updateProfileInfo_run_8434']['__ts']
        id = argv['Op_Doctor_updateProfileInfo_run_8434']['id']
        doctor_user_id = argv['Op_Doctor_updateProfileInfo_run_8434']['doctor_user_id']
        sys_user_person_id = argv['Op_Doctor_updateProfileInfo_run_8434']['sys_user_person_id']
        person_person_id = argv['Op_Doctor_updateProfileInfo_run_8434']['person_person_id']
        person__ts = state['TABLE_person'].get({'person_id': state['TABLE_sys_user'].get({'user_id': state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_Doctor_updateProfileInfo_run_8434']['id']}, 'user_id')}, 'person_id')}, '__ts')
        return And((person__ts < now))
...
class Op_Pharmacist_updateProfileInfo_run_8435():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_updateProfileInfo_run_8435']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_updateProfileInfo_run_8435']['now']
        __ts = argv['Op_Pharmacist_updateProfileInfo_run_8435']['__ts']
        id = argv['Op_Pharmacist_updateProfileInfo_run_8435']['id']
        address = argv['Op_Pharmacist_updateProfileInfo_run_8435']['address']
        sys_user_person_id = argv['Op_Pharmacist_updateProfileInfo_run_8435']['sys_user_person_id']
        person_person_id = argv['Op_Pharmacist_updateProfileInfo_run_8435']['person_person_id']
        person__ts = state['TABLE_person'].get({'person_id': state['TABLE_sys_user'].get({'user_id': argv['Op_Pharmacist_updateProfileInfo_run_8435']['id']}, 'person_id')}, '__ts')
        return And((person__ts < now))
...
class Op_Doctor_bill_run_8436():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_bill_run_8436']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_bill_run_8436']['now']
        __ts = argv['Op_Doctor_bill_run_8436']['__ts']
        id = argv['Op_Doctor_bill_run_8436']['id']
        tmp_bill_tmp_bill_id = argv['Op_Doctor_bill_run_8436']['tmp_bill_tmp_bill_id']
        tmp_bill__ts = state['TABLE_tmp_bill'].get({'tmp_bill_id': state['TABLE_tmp_bill'].get({'patient_id': argv['Op_Doctor_bill_run_8436']['id']}, 'tmp_bill_id')}, '__ts')
        return And((tmp_bill__ts < now))
...
class Op_LabAssistant_BloodGroupingTest_run_8437():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_BloodGroupingTest_run_8437', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_BloodGroupingTest_run_8437']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        BloodGroupingRh__ts = state['TABLE_BloodGroupingRh'].get({'tst_bloodG_id': BloodGroupingRh_tst_bloodG_id}, '__ts')
        return And((BloodGroupingRh__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        BloodGroupingRh_rhesusD = argv['Op_LabAssistant_BloodGroupingTest_run_8437']['rh']
        BloodGroupingRh_date = argv['Op_LabAssistant_BloodGroupingTest_run_8437']['now']
        state['TABLE_BloodGroupingRh'].add({'tst_bloodG_id': BloodGroupingRh_tst_bloodG_id}, {'appointment_id': BloodGroupingRh_appointment_id,'bloodGroup': BloodGroupingRh_bloodGroup,'rhesusD': BloodGroupingRh_rhesusD,'date': BloodGroupingRh_date, '__ts': now})
        return state
...
class Op_Doctor_prescribe_run_8438():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Doctor_prescribe_run_8438', 'newPrescId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_prescribe_run_8438']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_prescribe_run_8438']['now']
        __ts = argv['Op_Doctor_prescribe_run_8438']['__ts']
        newPrescId = argv['Op_Doctor_prescribe_run_8438']['newPrescId']
        patientId = argv['Op_Doctor_prescribe_run_8438']['patientId']
        consultantId = argv['Op_Doctor_prescribe_run_8438']['consultantId']
        ...
        prescription__ts = state['TABLE_prescription'].get({'prescription_id': prescription_prescription_id}, '__ts')
        return And((prescription__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        prescription_drugs_dose = argv['Op_Doctor_prescribe_run_8438']['drugDose']
        prescription_tests = argv['Op_Doctor_prescribe_run_8438']['tests']
        state['TABLE_prescription'].add({'prescription_id': prescription_prescription_id}, {'patient_id': prescription_patient_id,'consultant_id': prescription_consultant_id,'date': prescription_date,'drugs_dose': prescription_drugs_dose,'tests': prescription_tests, '__ts': now})
        return state
...
class Op_Receptionist_setPatientInfo_run_8439():
    def __init__(self):
        ...
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Receptionist_setPatientInfo_run_8439', 'newPersonId'), AxiomUniqueArgument('Op_Receptionist_setPatientInfo_run_8439', 'newPatientId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_setPatientInfo_run_8439']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Receptionist_setPatientInfo_run_8439']['now']
        __ts = argv['Op_Receptionist_setPatientInfo_run_8439']['__ts']
        newPersonId = argv['Op_Receptionist_setPatientInfo_run_8439']['newPersonId']
        newPatientId = argv['Op_Receptionist_setPatientInfo_run_8439']['newPatientId']
        nic = argv['Op_Receptionist_setPatientInfo_run_8439']['nic']
    ...
    def csop1(self, state, argv):
        ...
        patient__ts = state['TABLE_patient'].get({'patient_id': patient_patient_id}, '__ts')
        return And((person__ts < now), (patient__ts < now))
    ...
    def sop1(self, state, argv):
        ...
        patient_person_id = argv['Op_Receptionist_setPatientInfo_run_8439']['newPersonId']
        patient_drug_allergies_and_reactions = argv['Op_Receptionist_setPatientInfo_run_8439']['patientInfo']
        state['TABLE_patient'].add({'patient_id': patient_patient_id}, {'person_id': patient_person_id,'drug_allergies_and_reactions': patient_drug_allergies_and_reactions, '__ts': now})
        return state
...
class Op_LabAssistant_RenalFunctionTest_run_8440():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_RenalFunctionTest_run_8440', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_RenalFunctionTest_run_8440']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        RenalFunctionTest__ts = state['TABLE_RenalFunctionTest'].get({'tst_renal_id': RenalFunctionTest_tst_renal_id}, '__ts')
        return And((RenalFunctionTest__ts < now))
...
class Op_Admin_updateProfileInfo_run_8441():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Admin_updateProfileInfo_run_8441']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Admin_updateProfileInfo_run_8441']['now']
        __ts = argv['Op_Admin_updateProfileInfo_run_8441']['__ts']
        id = argv['Op_Admin_updateProfileInfo_run_8441']['id']
        sys_user_person_id = argv['Op_Admin_updateProfileInfo_run_8441']['sys_user_person_id']
        person_person_id = argv['Op_Admin_updateProfileInfo_run_8441']['person_person_id']
        person__ts = state['TABLE_person'].get({'person_id': state['TABLE_sys_user'].get({'user_id': argv['Op_Admin_updateProfileInfo_run_8441']['id']}, 'person_id')}, '__ts')
        return And((person__ts < now))
...
class Op_Admin_resetPassword_run_8442():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Admin_resetPassword_run_8442']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Admin_resetPassword_run_8442']['now']
        __ts = argv['Op_Admin_resetPassword_run_8442']['__ts']
        id = argv['Op_Admin_resetPassword_run_8442']['id']
        sys_user_user_id = argv['Op_Admin_resetPassword_run_8442']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': argv['Op_Admin_resetPassword_run_8442']['id']}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_sys_user'].update({'user_id': argv['Op_Admin_resetPassword_run_8442']['id']}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_Receptionist_refund_run_8443():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Receptionist_refund_run_8443', 'newRefundId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_refund_run_8443']['__ts']
...
class Op_Admin_unsuspendUser_run_8444():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Admin_unsuspendUser_run_8444']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Admin_unsuspendUser_run_8444']['now']
        __ts = argv['Op_Admin_unsuspendUser_run_8444']['__ts']
        id = argv['Op_Admin_unsuspendUser_run_8444']['id']
        sys_user_user_id = argv['Op_Admin_unsuspendUser_run_8444']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': argv['Op_Admin_unsuspendUser_run_8444']['id']}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        sys_user_suspend = 0
        state['TABLE_sys_user'].update({'user_id': argv['Op_Admin_unsuspendUser_run_8444']['id']}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_Receptionist_makeLabAppointment_run_8445():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0), (self.cond1, self.csop1, self.sop1), (self.cond2, self.csop2, self.sop2)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Receptionist_makeLabAppointment_run_8445', 'newAppId'), AxiomUniqueArgument('Op_Receptionist_makeLabAppointment_run_8445', 'newTmpBillId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_makeLabAppointment_run_8445']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Receptionist_makeLabAppointment_run_8445']['now']
        __ts = argv['Op_Receptionist_makeLabAppointment_run_8445']['__ts']
        newAppId = argv['Op_Receptionist_makeLabAppointment_run_8445']['newAppId']
        testId = argv['Op_Receptionist_makeLabAppointment_run_8445']['testId']
        patientId = argv['Op_Receptionist_makeLabAppointment_run_8445']['patientId']
        ...
        lab_appointment__ts = state['TABLE_lab_appointment'].get({'lab_appointment_id': lab_appointment_lab_appointment_id}, '__ts')
        return And((lab_appointment__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        lab_appointment_date = (argv['Op_Receptionist_makeLabAppointment_run_8445']['currentDate'])+(argv['Op_Receptionist_makeLabAppointment_run_8445']['day'])
        lab_appointment_cancelled = False
        state['TABLE_lab_appointment'].add({'lab_appointment_id': lab_appointment_lab_appointment_id}, {'test_id': lab_appointment_test_id,'patient_id': lab_appointment_patient_id,'doctor_id': lab_appointment_doctor_id,'date': lab_appointment_date,'cancelled': lab_appointment_cancelled, '__ts': now})
        return state
    ...
    def csop1(self, state, argv):
        ...
        lab_appointment_cancelled = False
        lab_appointment__ts = state['TABLE_lab_appointment'].get({'lab_appointment_id': lab_appointment_lab_appointment_id}, '__ts')
        tmp_bill__ts = state['TABLE_tmp_bill'].get({'tmp_bill_id': state['TABLE_tmp_bill'].get({'patient_id': argv['Op_Receptionist_makeLabAppointment_run_8445']['patientId']}, 'tmp_bill_id')}, '__ts')
        return And((lab_appointment__ts < now), (tmp_bill__ts < now))
    ...
    def csop2(self, state, argv):
        ...
        tmp_bill_laboratory_fee = state['TABLE_lab_test'].get({'test_id': argv['Op_Receptionist_makeLabAppointment_run_8445']['testId']}, 'test_fee')
        tmp_bill__ts = state['TABLE_tmp_bill'].get({'tmp_bill_id': tmp_bill_tmp_bill_id}, '__ts')
        return And((lab_appointment__ts < now), (tmp_bill__ts < now))
    ...
    def sop2(self, state, argv):
        ...
        tmp_bill_patient_id = argv['Op_Receptionist_makeLabAppointment_run_8445']['patientId']
        tmp_bill_laboratory_fee = state['TABLE_lab_test'].get({'test_id': argv['Op_Receptionist_makeLabAppointment_run_8445']['testId']}, 'test_fee')
        state['TABLE_tmp_bill'].add({'tmp_bill_id': tmp_bill_tmp_bill_id}, {'patient_id': tmp_bill_patient_id,'laboratory_fee': tmp_bill_laboratory_fee, '__ts': now})
        return state
...
class Op_LabAssistant_LipidTest_run_8446():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_LipidTest_run_8446', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_LipidTest_run_8446']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        LipidTest__ts = state['TABLE_LipidTest'].get({'tst_li_id': LipidTest_tst_li_id}, '__ts')
        return And((LipidTest__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        LipidTest_totalCholestrolLDLHDLratio = argv['Op_LabAssistant_LipidTest_run_8446']['totalCholestrolLDLHDLratio']
        LipidTest_date = argv['Op_LabAssistant_LipidTest_run_8446']['now']
        state['TABLE_LipidTest'].add({'tst_li_id': LipidTest_tst_li_id}, {'appointment_id': LipidTest_appointment_id,'cholestrolHDL': LipidTest_cholestrolHDL,'cholestrolLDL': LipidTest_cholestrolLDL,'triglycerides': LipidTest_triglycerides,'totalCholestrolLDLHDLratio': LipidTest_totalCholestrolLDLHDLratio,'date': LipidTest_date, '__ts': now})
        return state
...
class Op_Doctor_updateAccountInfo_run_8447():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_updateAccountInfo_run_8447']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Doctor_updateAccountInfo_run_8447']['now']
        __ts = argv['Op_Doctor_updateAccountInfo_run_8447']['__ts']
        id = argv['Op_Doctor_updateAccountInfo_run_8447']['id']
        doctor_user_id = argv['Op_Doctor_updateAccountInfo_run_8447']['doctor_user_id']
        sys_user_user_id = argv['Op_Doctor_updateAccountInfo_run_8447']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_Doctor_updateAccountInfo_run_8447']['id']}, 'user_id')}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_sys_user'].update({'user_id': state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_Doctor_updateAccountInfo_run_8447']['id']}, 'user_id')}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_LabAssistant_completeBloodCount_run_8448():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_completeBloodCount_run_8448', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_completeBloodCount_run_8448']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        completeBloodCount__ts = state['TABLE_completeBloodCount'].get({'tst_CBC_id': completeBloodCount_tst_CBC_id}, '__ts')
        return And((completeBloodCount__ts < now))
...
class Op_Receptionist_makeAppointment_run_8449():
    def __init__(self):
        ...
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Receptionist_makeAppointment_run_8449', 'newAppId'), AxiomUniqueArgument('Op_Receptionist_makeAppointment_run_8449', 'newTmpBillId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_makeAppointment_run_8449']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Receptionist_makeAppointment_run_8449']['now']
        __ts = argv['Op_Receptionist_makeAppointment_run_8449']['__ts']
        newAppId = argv['Op_Receptionist_makeAppointment_run_8449']['newAppId']
        patientId = argv['Op_Receptionist_makeAppointment_run_8449']['patientId']
        doctorId = argv['Op_Receptionist_makeAppointment_run_8449']['doctorId']
        ...
        appointment__ts = state['TABLE_appointment'].get({'appointment_id': appointment_appointment_id}, '__ts')
        return And((appointment__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        appointment_date = (argv['Op_Receptionist_makeAppointment_run_8449']['currentDate'])+(argv['Op_Receptionist_makeAppointment_run_8449']['day'])
        appointment_cancelled = False
        state['TABLE_appointment'].add({'appointment_id': appointment_appointment_id}, {'patient_id': appointment_patient_id,'slmc_reg_no': appointment_slmc_reg_no,'date': appointment_date,'cancelled': appointment_cancelled, '__ts': now})
        return state
    ...
    def csop1(self, state, argv):
        ...
        appointment_cancelled = False
        appointment__ts = state['TABLE_appointment'].get({'appointment_id': appointment_appointment_id}, '__ts')
        doctor_availability__ts = state['TABLE_doctor_availability'].get({'time_slot': argv['Op_Receptionist_makeAppointment_run_8449']['timeSlot'],'slmc_reg_no': argv['Op_Receptionist_makeAppointment_run_8449']['doctorId'],'day': argv['Op_Receptionist_makeAppointment_run_8449']['day']}, '__ts')
        return And((appointment__ts < now), (doctor_availability__ts < now))
    ...
    def csop3(self, state, argv):
        ...
        appointment__ts = state['TABLE_appointment'].get({'appointment_id': appointment_appointment_id}, '__ts')
        doctor_availability__ts = state['TABLE_doctor_availability'].get({'time_slot': argv['Op_Receptionist_makeAppointment_run_8449']['timeSlot'],'slmc_reg_no': argv['Op_Receptionist_makeAppointment_run_8449']['doctorId'],'day': argv['Op_Receptionist_makeAppointment_run_8449']['day']}, '__ts')
        tmp_bill__ts = state['TABLE_tmp_bill'].get({'tmp_bill_id': state['TABLE_tmp_bill'].get({'patient_id': argv['Op_Receptionist_makeAppointment_run_8449']['patientId']}, 'tmp_bill_id')}, '__ts')
        return And((appointment__ts < now), (doctor_availability__ts < now), (tmp_bill__ts < now))
    ...
    def sop5(self, state, argv):
        ...
        tmp_bill_appointment_fee = 500
        tmp_bill_tmp_bill_id = argv['Op_Receptionist_makeAppointment_run_8449']['newTmpBillId']
        state['TABLE_tmp_bill'].add({'tmp_bill_id': tmp_bill_tmp_bill_id}, {'patient_id': tmp_bill_patient_id,'appointment_fee': tmp_bill_appointment_fee, '__ts': now})
        return state
...
class Op_Pharmacist_addNewSupplier_run_8450():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Pharmacist_addNewSupplier_run_8450', 'newSupplierId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_addNewSupplier_run_8450']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_addNewSupplier_run_8450']['now']
        __ts = argv['Op_Pharmacist_addNewSupplier_run_8450']['__ts']
        newSupplierId = argv['Op_Pharmacist_addNewSupplier_run_8450']['newSupplierId']
        name = argv['Op_Pharmacist_addNewSupplier_run_8450']['name']
        ...
        suppliers__ts = state['TABLE_suppliers'].get({'supplier_id': suppliers_supplier_id}, '__ts')
        return And((suppliers__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        suppliers_supplier_id = argv['Op_Pharmacist_addNewSupplier_run_8450']['newSupplierId']
        suppliers_supplier_name = argv['Op_Pharmacist_addNewSupplier_run_8450']['name']
        state['TABLE_suppliers'].add({'supplier_id': suppliers_supplier_id}, {'supplier_name': suppliers_supplier_name, '__ts': now})
        return state
...
class Op_Pharmacist_updatePharmacistInfo_run_8451():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['now']
        __ts = argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['__ts']
        id = argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['id']
        pharmacist_pharmacist_id = argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['pharmacist_pharmacist_id']
        pharmacist__ts = state['TABLE_pharmacist'].get({'pharmacist_id': argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['id']}, '__ts')
        return And((pharmacist__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_pharmacist'].update({'pharmacist_id': argv['Op_Pharmacist_updatePharmacistInfo_run_8451']['id']}, {'pharmacist_id': pharmacist_pharmacist_id, 'user_id': pharmacist_user_id, 'education': pharmacist_education, 'training': pharmacist_training, 'experience': pharmacist_experience, 'achievements': pharmacist_achievements, '__ts': now})
        return state
...
class Op_LabAssistant_updateProfileInfo_run_8452():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_updateProfileInfo_run_8452']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_LabAssistant_updateProfileInfo_run_8452']['now']
        __ts = argv['Op_LabAssistant_updateProfileInfo_run_8452']['__ts']
        id = argv['Op_LabAssistant_updateProfileInfo_run_8452']['id']
        sys_user_person_id = argv['Op_LabAssistant_updateProfileInfo_run_8452']['sys_user_person_id']
        person_person_id = argv['Op_LabAssistant_updateProfileInfo_run_8452']['person_person_id']
        person__ts = state['TABLE_person'].get({'person_id': state['TABLE_sys_user'].get({'user_id': argv['Op_LabAssistant_updateProfileInfo_run_8452']['id']}, 'person_id')}, '__ts')
        return And((person__ts < now))
...
class Op_Cashier_removeFromTempBill_run_8453():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Cashier_removeFromTempBill_run_8453']['__ts']
        id = argv['Op_Cashier_removeFromTempBill_run_8453']['id']
        return True

    def csop0(self, state, argv):
        now = argv['Op_Cashier_removeFromTempBill_run_8453']['now']
        __ts = argv['Op_Cashier_removeFromTempBill_run_8453']['__ts']
        id = argv['Op_Cashier_removeFromTempBill_run_8453']['id']
        return And()
...
class Op_LabAssistant_liverFunctionTest_run_8454():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_liverFunctionTest_run_8454', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_liverFunctionTest_run_8454']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        LiverFunctionTest__ts = state['TABLE_LiverFunctionTest'].get({'tst_liver_id': LiverFunctionTest_tst_liver_id}, '__ts')
        return And((LiverFunctionTest__ts < now))
...
class Op_Receptionist_cancelLabAppointment_run_8455():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0), (self.cond1, self.csop1, self.sop1), (self.cond2, self.csop2, self.sop2)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Receptionist_cancelLabAppointment_run_8455', 'newRefundId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Receptionist_cancelLabAppointment_run_8455']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        labAppointmentId = argv['Op_Receptionist_cancelLabAppointment_run_8455']['labAppointmentId']
        lab_appointment_lab_appointment_id = argv['Op_Receptionist_cancelLabAppointment_run_8455']['lab_appointment_lab_appointment_id']
        lab_appointment__ts = state['TABLE_lab_appointment'].get({'lab_appointment_id': argv['Op_Receptionist_cancelLabAppointment_run_8455']['labAppointmentId']}, '__ts')
        return And((lab_appointment__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_lab_appointment'].update({'lab_appointment_id': argv['Op_Receptionist_cancelLabAppointment_run_8455']['labAppointmentId']}, {'lab_appointment_id': lab_appointment_lab_appointment_id, 'test_id': lab_appointment_test_id, 'date': lab_appointment_date, 'info': lab_appointment_info, 'patient_id': lab_appointment_patient_id, 'bill_id': lab_appointment_bill_id, 'lab_assistant_id': lab_appointment_lab_assistant_id, 'cancelled': lab_appointment_cancelled, 'doctor_id': lab_appointment_doctor_id, '__ts': now})
        return state
    ...
    def csop1(self, state, argv):
        ...
        refund__ts = state['TABLE_refund'].get({'refund_id': refund_refund_id}, '__ts')
        return And((lab_appointment__ts < now), (refund__ts < now))
    ...
    def csop2(self, state, argv):
        ...
        refund_date = argv['Op_Receptionist_cancelLabAppointment_run_8455']['now']
        refund__ts = state['TABLE_refund'].get({'refund_id': refund_refund_id}, '__ts')
        bill__ts = state['TABLE_bill'].get({'bill_id': state['TABLE_lab_appointment'].get({'lab_appointment_id': argv['Op_Receptionist_cancelLabAppointment_run_8455']['labAppointmentId']}, 'bill_id')}, '__ts')
        return And((lab_appointment__ts < now), (refund__ts < now), (bill__ts < now))
    ...
    def sop2(self, state, argv):
        ...
        bill_refund = 1
        state['TABLE_bill'].update({'bill_id': state['TABLE_lab_appointment'].get({'lab_appointment_id': argv['Op_Receptionist_cancelLabAppointment_run_8455']['labAppointmentId']}, 'bill_id')}, {'bill_id': bill_bill_id, 'bill_date': bill_bill_date, 'doctor_fee': bill_doctor_fee, 'hospital_fee': bill_hospital_fee, 'pharmacy_fee': bill_pharmacy_fee, 'laboratory_fee': bill_laboratory_fee, 'appointment_fee': bill_appointment_fee, 'vat': bill_vat, 'discount': bill_discount, 'total': bill_total, 'payment_method': bill_payment_method, 'consultant_id': bill_consultant_id, 'patient_id': bill_patient_id, 'refund': bill_refund, '__ts': now})
        return state
...
class Op_Pharmacist_addNewBrand_run_8456():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_Pharmacist_addNewBrand_run_8456', 'newBrandId'))

    def cond0(self, state, argv):
        __ts = argv['Op_Pharmacist_addNewBrand_run_8456']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Pharmacist_addNewBrand_run_8456']['now']
        __ts = argv['Op_Pharmacist_addNewBrand_run_8456']['__ts']
        newBrandId = argv['Op_Pharmacist_addNewBrand_run_8456']['newBrandId']
        brandName = argv['Op_Pharmacist_addNewBrand_run_8456']['brandName']
        genericName = argv['Op_Pharmacist_addNewBrand_run_8456']['genericName']
        ...
        drug_brand_names__ts = state['TABLE_drug_brand_names'].get({'brand_id': drug_brand_names_brand_id}, '__ts')
        return And((drug_brand_names__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        drug_brand_names_drug_unit = argv['Op_Pharmacist_addNewBrand_run_8456']['drugUnit']
        drug_brand_names_unit_price = argv['Op_Pharmacist_addNewBrand_run_8456']['unitPrice']
        state['TABLE_drug_brand_names'].add({'brand_id': drug_brand_names_brand_id}, {'brand_name': drug_brand_names_brand_name,'generic_name': drug_brand_names_generic_name,'drug_type': drug_brand_names_drug_type,'drug_unit': drug_brand_names_drug_unit,'unit_price': drug_brand_names_unit_price, '__ts': now})
        return state
...
class Op_LabAssistant_SeriumCreatinePhosphokinase_run_8457():
    def __init__(self):
        self.sops = [(self.cond0, self.csop0, self.sop0)]
        self.axiom = AxiomsAnd(AxiomUniqueArgument('Op_LabAssistant_SeriumCreatinePhosphokinase_run_8457', 'newTstId'))

    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_SeriumCreatinePhosphokinase_run_8457']['__ts']
    ...
    def csop0(self, state, argv):
        ...
        SeriumCreatinePhosphokinase__ts = state['TABLE_SeriumCreatinePhosphokinase'].get({'tst_SCP_id': SeriumCreatinePhosphokinase_tst_SCP_id}, '__ts')
        return And((SeriumCreatinePhosphokinase__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        SeriumCreatinePhosphokinase_hiv12ELISA = argv['Op_LabAssistant_SeriumCreatinePhosphokinase_run_8457']['hiv12ELISA']
        SeriumCreatinePhosphokinase_date = argv['Op_LabAssistant_SeriumCreatinePhosphokinase_run_8457']['now']
        state['TABLE_SeriumCreatinePhosphokinase'].add({'tst_SCP_id': SeriumCreatinePhosphokinase_tst_SCP_id}, {'appointment_id': SeriumCreatinePhosphokinase_appointment_id,'hiv12ELISA': SeriumCreatinePhosphokinase_hiv12ELISA,'date': SeriumCreatinePhosphokinase_date, '__ts': now})
        return state
...
class Op_Doctor_removeDoctorTime_run_8458():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Doctor_removeDoctorTime_run_8458']['__ts']
        id = argv['Op_Doctor_removeDoctorTime_run_8458']['id']
        return True

    def csop0(self, state, argv):
        now = argv['Op_Doctor_removeDoctorTime_run_8458']['now']
        __ts = argv['Op_Doctor_removeDoctorTime_run_8458']['__ts']
        id = argv['Op_Doctor_removeDoctorTime_run_8458']['id']
        return And()
...
class Op_Admin_updateAccountInfo_run_8459():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Admin_updateAccountInfo_run_8459']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Admin_updateAccountInfo_run_8459']['now']
        __ts = argv['Op_Admin_updateAccountInfo_run_8459']['__ts']
        id = argv['Op_Admin_updateAccountInfo_run_8459']['id']
        sys_user_user_id = argv['Op_Admin_updateAccountInfo_run_8459']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': argv['Op_Admin_updateAccountInfo_run_8459']['id']}, '__ts')
        return And((sys_user__ts < now))
    ...
    def sop0(self, state, argv):
        ...
        state['TABLE_sys_user'].update({'user_id': argv['Op_Admin_updateAccountInfo_run_8459']['id']}, {'person_id': sys_user_person_id, 'user_id': sys_user_user_id, 'user_name': sys_user_user_name, 'user_type': sys_user_user_type, 'other_info': sys_user_other_info, 'password': sys_user_password, 'online': sys_user_online, 'login': sys_user_login, 'logout': sys_user_logout, 'profile_pic': sys_user_profile_pic, 'suspend': sys_user_suspend, '__ts': now})
        return state
...
class Op_LabAssistant_updateAccountInfo_run_8460():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_LabAssistant_updateAccountInfo_run_8460']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_LabAssistant_updateAccountInfo_run_8460']['now']
        __ts = argv['Op_LabAssistant_updateAccountInfo_run_8460']['__ts']
        id = argv['Op_LabAssistant_updateAccountInfo_run_8460']['id']
        doctor_user_id = argv['Op_LabAssistant_updateAccountInfo_run_8460']['doctor_user_id']
        sys_user_user_id = argv['Op_LabAssistant_updateAccountInfo_run_8460']['sys_user_user_id']
        sys_user__ts = state['TABLE_sys_user'].get({'user_id': state['TABLE_doctor'].get({'slmc_reg_no': argv['Op_LabAssistant_updateAccountInfo_run_8460']['id']}, 'user_id')}, '__ts')
        return And((sys_user__ts < now))
...
class Op_Cashier_updateProfileInfo_run_8461():
    ...
    def cond0(self, state, argv):
        __ts = argv['Op_Cashier_updateProfileInfo_run_8461']['__ts']
    ...
    def csop0(self, state, argv):
        now = argv['Op_Cashier_updateProfileInfo_run_8461']['now']
        __ts = argv['Op_Cashier_updateProfileInfo_run_8461']['__ts']
        id = argv['Op_Cashier_updateProfileInfo_run_8461']['id']
        sys_user_person_id = argv['Op_Cashier_updateProfileInfo_run_8461']['sys_user_person_id']
        return And()
